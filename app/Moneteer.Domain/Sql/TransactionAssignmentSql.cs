namespace Moneteer.Domain.Sql
{
    ...
    {
        public static string Create = @"INSERT INTO app.transaction_assignment(id, transaction_id, envelope_id, account_id, inflow, outflow) VALUES(@Id, @TransactionId, @EnvelopeId, @AccountId, @Inflow, @Outflow)";
